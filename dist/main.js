...
exports.TabContent = exports.TabNavigation = exports.PanelTab = exports.Panel = exports.Layout = undefined;

var _Layout = __webpack_require__(31);

var _Layout2 = _interopRequireDefault(_Layout);

var _Panel = __webpack_require__(79);
...
var _TabNavigation = __webpack_require__(81);

var _TabNavigation2 = _interopRequireDefault(_TabNavigation);

var _TabContent = __webpack_require__(82);
...
exports.PanelTab = _PanelTab2.default;
...
var _ChangedFile = __webpack_require__(32);

var _ChangedFile2 = _interopRequireDefault(_ChangedFile);
...
var Properties = function (_React$Component) {
    ...
    function Properties() {
        ...
        return _possibleConstructorReturn(this, (Properties.__proto__ || Object.getPrototypeOf(Properties)).call(this));
    }
...
var Layout = function (_React$Component) {
    ...
    _createClass(Layout, [{
            ...
            children.forEach(function (item, i) {
                var Splitter = function Splitter() {
                    return _react2.default.createElement('hr', {
                        onMouseDown: _this2.toggleResize.bind(_this2, i),
                        onMouseUp: _this2.mouseUp.bind(_this2) });
                };

                var props = { key: result.length, style: { flexBasis: _this2.state.ratio[i] } };

                result.push(_react2.default.cloneElement(item, props));
                if (i != children.length - 1) result.push(_react2.default.createElement(Splitter, { key: result.length }));
            });
        ...
        key: 'toggleResize',
        value: function toggleResize(key, e) {
            var _this3 = this;
            ...
            this.setState(_extends({}, this.state, {
                ...
                window.addEventListener('mousemove', _this3.handleResize.bind(_this3));
                window.addEventListener('mouseup', _this3.mouseUp.bind(_this3));
            });
        }
        ...
        value: function mouseUp(e) {
            ...
            this.setState(_extends({}, this.state, {
                ...
                window.removeEventListener('mousemove', _this4.handleResize.bind(_this4));
                window.removeEventListener('mouseup', _this4.mouseUp.bind(_this4));
            });
        }
        ...
        value: function handleResize(e) {
            ...
            if (this.state.resizing) {
                ...
                var children = Array.from(parent.children).filter(function (item) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: this.props.className.concat(' layout') + (this.props.type == 'vertical' ? ' layout-vertical' : ''), style: this.props.style },
                this.getChildren()
            );
        }
    }]);
...
var ChangedFile = function (_React$Component) {
    _inherits(ChangedFile, _React$Component);

    function ChangedFile() {
        _classCallCheck(this, ChangedFile);

        var _this = _possibleConstructorReturn(this, (ChangedFile.__proto__ || Object.getPrototypeOf(ChangedFile)).call(this));
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(14),B=__webpack_require__(2),C=__webpack_require__(1),ba=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ia=__webpack_require__(19),D=__webpack_require__(4);
...
var _NavTab = __webpack_require__(83);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        key: 'render',
        value: function render() {
            var menu = [{ name: 'File', tabs: [[{ name: 'New...', shortcut: 'Ctrl+N' }, { name: 'Open', shortcut: 'Ctrl+O' }, { name: 'Synchronize...', shortcut: 'Ctrl+U', disabled: true }, { name: 'Save All', shortcut: 'Ctrl+S' }], [{ name: 'Open Assets...', shortcut: 'Ctrl+Shift+R' }, { name: 'Search in Files', shortcut: 'Ctrl+Shift+F' }], [{ name: 'Close', shortcut: 'Ctrl+W' }, { name: 'Close All', shortcut: 'Ctrl+Shift+W' }, { name: 'Close Others' }], [{ name: 'Preferences', shortcut: 'Ctrl+,' }, { name: 'Quit', shortcut: 'Ctrl+Q' }]] }, { name: 'Edit', tabs: [[{ name: 'Undo', shortcut: 'Ctrl+Z' }, { name: 'Redo', shortcut: 'Ctrl+Y' }], [{ name: 'Cut', shortcut: 'Ctrl+X' }, { name: 'Delete', shortcut: 'Delete' }, { name: 'Copy', shortcut: 'Ctrl+C' }, { name: 'Paste', shortcut: 'Ctrl+V' }]] }, { name: 'Project', tabs: [] }, { name: 'View', tabs: [] }, { name: 'Help', tabs: [] }];
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    menu.map(function (item, i) {
                        return _react2.default.createElement(_NavTab2.default, { name: item.name, tabs: item.tabs, key: i });
                    })
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'p',
                            { className: 'footer-information-file' },
...
var _Filetree = __webpack_require__(47);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Layout.Panel,
                    { 'init-ratio': '320' },
                    _react2.default.createElement(_Filetree2.default, { name: 'Assets', 'init-ratio': '75%' }),
                    _react2.default.createElement(_ChangedFile2.default, { name: 'Help' })
                ),
                _react2.default.createElement(_Layout.PanelTab, { className: 'canvas', 'init-ratio': '100%' })
            );
        }
    }]);
...
var _TabsAction = __webpack_require__(12);

var _TabsAction2 = _interopRequireDefault(_TabsAction);
...
var Filetree = function (_React$Component) {
    ...
    _createClass(Filetree, [{
        ...
        value: function componentDidMount() {
            ...
            this.loadFolder(filePath).then(function (folderData) {
                var treeview = _this2.state.treeview;
        ...
        */
        ...
        value: function loadFolder(folderPath) {
            ...
            return new Promise(function (resolve, reject) {
                resolve({ name: path.basename(folderPath), depth: 0, nodes: _this3.walk(folderPath) });
            });
        }
        ...
        */
        ...
        value: function walk(dir) {
            ...
            list.forEach(function (file) {
                ...
                if (stat.isDirectory()) {
                    results.push({ name: file, type: 'folder', depth: depth, nodes: _this4.walk(filePath, depth + 1) });
                } else {
                    results.push({ name: file, depth: depth, type: _this4.getExtension(file) });
                }
            });
        ...
        */
        ...
        key: 'createTabulation',
        value: function createTabulation(object) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'ul',
                { className: 'filetree filetree-wrapper' },
                this.state.treeview.map(function (item, i) {
                    return _react2.default.createElement(_TreeNode2.default, { data: item, key: i, active: true, handleAction: _this5.createTabulation.bind(_this5) });
                })
            );
        }
    }]);
...
var dispatchToProps = function dispatchToProps(dispatch) {
    return {
        addTab: function addTab(tabs) {
            return dispatch(_TabsAction2.default.addTab(tabs));
        },
        removeTab: function removeTab(tabID) {
            return dispatch(_TabsAction2.default.removeTab(tabID));
        }
    };
};

exports.default = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(Filetree);
...
var TreeNode = function (_React$Component) {
    ...
    function TreeNode(props) {
        ...
        _this.state = {
            active: _this.props.active ? _this.props.active : false,
            open: false
        };
        return _this;
    }
    ...
    _createClass(TreeNode, [{
        ...
        value: function handleToggleActive(e) {
        ...
        value: function handleClickAction(data, e) {
            ...
            if (data.nodes) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('i', { className: 'icon icon-folder' }),
                        data.name
                    ),
                    _react2.default.createElement(
                        'ul',
                        ...
                        data.nodes.map(function (item, i) {
                            return _react2.default.createElement(TreeNode, { key: i, data: item, handleAction: _this2.props.handleAction });
                        })
                    )
                );
            } else {
...
var Panel = function (_React$Component) {
    ...
    _createClass(Panel, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _Layout2.default,
                { className: 'panel', type: 'vertical', style: this.props.style },
                this.state.components.map(function (Component, i) {
                    return _react2.default.createElement(
                        'div',
                        _extends({ onDragOver: _this2.allowDrop.bind(_this2), key: i }, Component.props),
                        Component.props.name && _react2.default.createElement(
                            'h2',
                            { onDragStart: _this2.dragStart.bind(_this2),
                                draggable: 'true', 'data-key': i },
                            Component.props.name ? Component.props.name : 'Inconnues'
                        ),
                        Component.props.name ? _react2.default.createElement(
                            'div',
                            { className: 'module-content', onDrop: _this2.drop.bind(_this2), 'data-key': i },
                            Component
                        ) : _react2.default.createElement(
                            'div',
                            { className: 'module-content',
                                onDrop: _this2.drop.bind(_this2),
                                onDragStart: _this2.dragStart.bind(_this2),
                                draggable: 'true', 'data-key': i },
                            Component
                        )
...
var PanelTab = function (_React$Component) {
    _inherits(PanelTab, _React$Component);

    function PanelTab() {
        _classCallCheck(this, PanelTab);

        return _possibleConstructorReturn(this, (PanelTab.__proto__ || Object.getPrototypeOf(PanelTab)).call(this));
    }
    ...
    _createClass(PanelTab, [{
        key: 'closeTabulation',
        value: function closeTabulation(id) {
        ...
        key: 'changeTabulation',
        value: function changeTabulation(id) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    tabs.all.map(function (item, i) {
                        return _react2.default.createElement(
                            'span',
                            { className: "canvas-tab-item" + (tabs.active == i ? ' is-active' : ''), key: i,
                                onClick: _this2.changeTabulation.bind(_this2, i) },
                            _react2.default.createElement('i', { className: "icon icon-" + item.type }),
                            item.name,
                            _react2.default.createElement('i', { className: 'fa fa-times', onClick: _this2.closeTabulation.bind(_this2, i) })
                        );
                    })
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _Layout.TabContent,
                        { className: 'canvas-content', 'init-ratio': '100%' },
                        _react2.default.createElement(
                            'p',
                            null,
                    ...
                    _react2.default.createElement(
                        _Layout.Panel,
                        { 'init-ratio': '380' },
                        _react2.default.createElement(_Properties2.default, { name: 'Properties' })
                    )
                )
            );
        }
...
var dispatchToProps = function dispatchToProps(dispatch) {
    return {
        ...
        removeTab: function removeTab(id) {
            return dispatch(_TabsAction2.default.removeTab(id));
        },
        activeTab: function activeTab(id) {
            return dispatch(_TabsAction2.default.activeTab(id));
        }
    };
};

exports.default = (0, _reactRedux.connect)(stateToProps, dispatchToProps)(PanelTab);
...
var TabNavigation = function (_React$Component) {
    ...
    function TabNavigation() {
        ...
        return _possibleConstructorReturn(this, (TabNavigation.__proto__ || Object.getPrototypeOf(TabNavigation)).apply(this, arguments));
    }
    ...
    _createClass(TabNavigation, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "span",
                    { className: "canvas-tab-item is-active" },
                    "Menu.scene",
                    _react2.default.createElement("i", { className: "fa fa-times" })
                ),
                _react2.default.createElement(
                    "span",
                    { className: "canvas-tab-item" },
                    _react2.default.createElement("i", { className: "icon icon-module" }),
                    "Sprite.module",
                    _react2.default.createElement("i", { className: "fa fa-times" })
                )
            );
...
var NavTab = function (_React$Component) {
    ...
    function NavTab(props) {
        ...
        var _this = _possibleConstructorReturn(this, (NavTab.__proto__ || Object.getPrototypeOf(NavTab)).call(this, props));
    ...
    _createClass(NavTab, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'span',
                { className: "nav-item" + (this.state.active ? ' is-active' : '') },
                _react2.default.createElement(
                    'a',
                ...
                this.props.tabs && _react2.default.createElement(
                    'ul',
                    { className: 'menu-sub' },
                    this.props.tabs.map(function (group, i) {
                        return _react2.default.createElement(
                            'ul',
                            { className: 'menu-sub-group', key: i },
                            group.map(function (item, j) {
                                return _react2.default.createElement(
                                    'li',
                                    { className: item.disabled ? 'is-disabled' : '', key: j },
                                    item.name,
...
var _TabsReducer = __webpack_require__(86);
